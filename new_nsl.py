...
def parse_example(example_proto):
  ...
  for i in range(HPARAMS.num_neighbors):
    nbr_feature_key = '{}{}_{}'.format(NBR_FEATURE_PREFIX, i, 'beam_features')
    print('nbr_feature_key:', nbr_feature_key )
    nbr_weight_key = '{}{}{}'.format(NBR_FEATURE_PREFIX, i, NBR_WEIGHT_SUFFIX)
    print('nbr_weight_key:', nbr_weight_key)
    feature_spec[nbr_feature_key] = tf.io.FixedLenFeature([HPARAMS.max_seq_length],
                                tf.float32,
                                default_value=tf.constant(
                                    0,
                                    dtype=tf.float32,
...
def make_mlp_sequential_model(hparams):
  ...
  model.add(
      tf.keras.layers.InputLayer(
          input_shape=(HPARAMS.max_seq_length), name='beam_features')) #name='words'
...
def make_mlp_functional_model(hparams):
  ...
  inputs = tf.keras.Input(
      shape=(HPARAMS.max_seq_length,), dtype='int64', name='beam_features') # name='words'
...
# base_model_tag, base_model = 'FUNCTIONAL', make_mlp_sequential_model(HPARAMS)
# base_model_tag, base_model = 'FUNCTIONAL', make_model()
